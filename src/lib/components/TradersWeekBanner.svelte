...
<section
	class="sticky top-20 z-40 border-b border-green-electric/45 bg-gradient-to-r from-green-electric/20 via-green-electric/[0.07] to-violet-accent/15 shadow-[0_4px_28px_rgba(0,220,130,0.12)] backdrop-blur-md"
